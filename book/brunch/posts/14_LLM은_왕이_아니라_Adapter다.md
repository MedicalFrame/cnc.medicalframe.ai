브런치 제목: LLM은 왕이 아니라 Adapter다
브런치 부제: LLM은 글쓰기 도구를 넘어 형식과 의미를 연결하는 adapter다
매거진: Codex, 니 이름은 이제부터 춘식이여
업로드 메모: 브런치 업로드 전 제목, 부제, 이미지, 개인정보를 최종 확인할 것. 로컬 이미지 8개는 브런치 업로드 후 URL 교체 필요.
이미지 후보: ../../CNC_gpt/image/14/1.png, ../../CNC_gpt/image/14/2.png, ../../CNC_gpt/image/14/3.png, ../../CNC_gpt/image/14/4.png, ../../output/cncbook_images/CNC_gpt_image_14_1_5744de6cd0.jpg, ../../output/cncbook_images/CNC_gpt_image_14_2_1db8ff6735.jpg, ../../output/cncbook_images/CNC_gpt_image_14_3_8b24dab795.jpg, ../../output/cncbook_images/CNC_gpt_image_14_4_278870844c.jpg
---
