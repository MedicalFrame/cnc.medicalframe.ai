브런치 제목: lessons.md: 경험을 재사용 가능한 원칙으로 바꾸기
브런치 부제: 경험은 lesson으로 만들 때 다음 행동을 바꾸는 자산이 된다
매거진: Codex, 니 이름은 이제부터 춘식이여
업로드 메모: 브런치 업로드 전 제목, 부제, 이미지, 개인정보를 최종 확인할 것. 로컬 이미지 8개는 브런치 업로드 후 URL 교체 필요.
이미지 후보: ../../CNC_gpt/image/10/Pasted Image (1).png, ../../CNC_gpt/image/10/Pasted Image (2).png, ../../CNC_gpt/image/10/Pasted Image (3).png, ../../CNC_gpt/image/10/Pasted Image.png, ../../output/cncbook_images/CNC_gpt_image_10_Pasted_Image_1_0b47610b12.jpg, ../../output/cncbook_images/CNC_gpt_image_10_Pasted_Image_2_ad122ce4e2.jpg, ../../output/cncbook_images/CNC_gpt_image_10_Pasted_Image_3_8f757ff5db.jpg, ../../output/cncbook_images/CNC_gpt_image_10_Pasted_Image_8ae6d21d77.jpg
---
